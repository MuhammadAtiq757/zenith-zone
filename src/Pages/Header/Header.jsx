...
const handleDarkMode = (event) => {
  if (event.target.checked) {
    ...
    return (
        <div>
            <div className="navbar  bg-gray-800 px-6">
  <div className="navbar-start ">
    <div className="dropdown  ">
      ...
      <li><div className='lg:flex'>
                                <label className="swap swap-rotate">

                                <input type="checkbox" checked={theme === 'dark'} onChange={handleDarkMode} />
    ...
    <a className=" text-3xl font-serif font-bold"><small className='text-3xl font-serif font-bold  p-3'>Zenith</small></a>
  </div>
  <div className="navbar-center hidden s lg:flex">
