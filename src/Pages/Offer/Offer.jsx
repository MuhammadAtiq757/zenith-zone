            ...
            <div>
                ...
                <div className='  grid md:grid-cols-3 gap-2 mx-auto px-6 items-center justify-center  text-center  pt-24'>
                    ...
                    <div className='card justify-center items-center  p-3  rounded-lg broder border-1  bg-gray-100 shadow-lg border-y-2 border-blue-400 '>
                        ...
                        <p className='font-extralight text-gray-600 pt-4'>Lorem, ipsum dolor sit amet  consectetur  adipisicing elit.Voluptatem, quibusdam.</p>
                    </div>


                    <div className='card justify-center items-center  p-4  rounded-lg broder border-1  bg-gray-100 shadow-lg border-y-2 border-blue-400 '>
                    ...
                    <div className='card justify-center items-center  p-4  hover:text-white rounded-lg broder border-1  bg-gray-100 shadow-lg border-y-2 border-blue-400 '>
